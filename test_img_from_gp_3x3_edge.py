...
for p in points:
    newimg[p] =round(abs(func( datanoise[p[0]-1,p[1]-1],  datanoise[p[0]-1,p[1]],  datanoise[p[0]-1,p[1]+1],  datanoise[p[0],p[1]-1], datanoise[p], datanoise[p[0],p[1]+1], datanoise[p[0]+1,p[1]-1], datanoise[p[0]+1,p[1]], datanoise[p[0]+1,p[1]+1])))

#save
newimg[newimg>=20]=255
newimg[newimg<20]=0
