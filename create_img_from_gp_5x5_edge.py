...
datanoise_noborder = datanoise[2:-2, 2:-2]
...
points=[(y,x) for y in range(2,SIZE-2) for x in range(2,SIZE-2)]
newimg = numpy.zeros((SIZE,SIZE),dtype=int)
for p in points:
    newimg[p] = abs(func( datanoise[p[0]-2,p[1]-2],
